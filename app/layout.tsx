...
export const metadata: Metadata = {
  ...
  description: "Review flashcards on an Ebbinghaus forgetting-curve schedule.",
};
      ...
      <body className="min-h-full flex flex-col">
        ...
        <footer className="border-t border-[var(--border)]">
          <div className="mx-auto max-w-4xl px-6 py-4 text-xs text-[var(--muted)]">
            Ebbinghaus schedule — 10min, 30min, 1h, 2h, 3h, 6h, 12h, 1d, 2d, 3d,
            5d, 10d, 15d, 1mo, 2mo, 3mo.
          </div>
        </footer>
      </body>
    </html>
